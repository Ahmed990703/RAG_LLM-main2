...
import os
import sys
from RagLlm.ocr_rag_system import OCR_RAG_System
ocr_system = OCR_RAG_System(gemini_api_key='AIzaSyAFLqDuBXJovJCXseE-4N3OnyelHorgFIA',knowledge_base_path='knowledge_base.pkl')
